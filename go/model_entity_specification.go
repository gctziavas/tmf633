...
// AssertEntitySpecificationRequired checks if the required fields are not zero-ed
func AssertEntitySpecificationRequired(obj EntitySpecification) error {
...
// AssertRecurseEntitySpecificationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of EntitySpecification (e.g. [][]EntitySpecification), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseEntitySpecificationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aEntitySpecification, ok := obj.(EntitySpecification)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertEntitySpecificationRequired(aEntitySpecification)
	})
}
