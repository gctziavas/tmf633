...
// AssertServiceCandidateCreateRequired checks if the required fields are not zero-ed
func AssertServiceCandidateCreateRequired(obj ServiceCandidateCreate) error {
...
// AssertRecurseServiceCandidateCreateRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ServiceCandidateCreate (e.g. [][]ServiceCandidateCreate), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceCandidateCreateRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceCandidateCreate, ok := obj.(ServiceCandidateCreate)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceCandidateCreateRequired(aServiceCandidateCreate)
	})
}
