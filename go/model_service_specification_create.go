...
// ServiceSpecificationCreate - ServiceSpecification is a class that offers characteristics to describe a type of service. Functionally, it acts as a template by which Services may be instantiated. By sharing the same specification, these services would therefore share the same set of characteristics. Skipped properties: id,href
type ServiceSpecificationCreate struct {
...
// AssertServiceSpecificationCreateRequired checks if the required fields are not zero-ed
func AssertServiceSpecificationCreateRequired(obj ServiceSpecificationCreate) error {
...
// AssertRecurseServiceSpecificationCreateRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ServiceSpecificationCreate (e.g. [][]ServiceSpecificationCreate), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceSpecificationCreateRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceSpecificationCreate, ok := obj.(ServiceSpecificationCreate)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceSpecificationCreateRequired(aServiceSpecificationCreate)
	})
}
