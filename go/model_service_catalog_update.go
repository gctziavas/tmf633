...
// AssertServiceCatalogUpdateRequired checks if the required fields are not zero-ed
func AssertServiceCatalogUpdateRequired(obj ServiceCatalogUpdate) error {
...
// AssertRecurseServiceCatalogUpdateRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ServiceCatalogUpdate (e.g. [][]ServiceCatalogUpdate), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceCatalogUpdateRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceCatalogUpdate, ok := obj.(ServiceCatalogUpdate)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceCatalogUpdateRequired(aServiceCatalogUpdate)
	})
}
